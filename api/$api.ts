...
import type { Methods as Methods1 } from './blogs/_blogId@number'
      ...
      _blogId: (val1: number) => {
        ...
        return {
          ...
          post: (option: { body: Methods1['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods1['post']['resBody'], BasicHeaders, Methods1['post']['status']>(prefix, prefix1, POST, option).json(),
          /**
           * ブログ作成
           * @returns Created
           */
          $post: (option: { body: Methods1['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods1['post']['resBody'], BasicHeaders, Methods1['post']['status']>(prefix, prefix1, POST, option).json().then(r => r.body),
          /**
           * ブログ更新
           * @returns OK
           */
